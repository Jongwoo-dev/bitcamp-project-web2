...
<tr><th>사진</th><td><img src='../upload/${teacher.photoList[0].filePath}' height='80px'><input name='photo' type='file'></td></tr>
<tr><th>사진</th><td><img src='../upload/${teacher.photoList[1].filePath}' height='80px'><input name='photo' type='file'></td></tr>
<tr><th>사진</th><td><img src='../upload/${teacher.photoList[2].filePath}' height='80px'><input name='photo' type='file'></td></tr>
</table>
